CREATE TABLE [dbo].[TPlanoSeniorFuneral] (
    [IDPlanoSeniorFuneral] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_TPlanoSeniorFuneral] PRIMARY KEY CLUSTERED ([IDPlanoSeniorFuneral] ASC) WITH (STATISTICS_NORECOMPUTE = ON)
);
