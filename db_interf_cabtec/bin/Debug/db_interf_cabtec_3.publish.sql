...
GO
PRINT N'Dropping unnamed constraint on [dbo].[MobileTSimuladorProduto]...';


GO
ALTER TABLE [dbo].[MobileTSimuladorProduto] DROP CONSTRAINT [DF__MobileTSi__TipoR__6EF57B66];
...
GO
ALTER TABLE [dbo].[MobileTSimuladorProduto] ALTER COLUMN [TipoRegistro] NCHAR (1) NULL;
