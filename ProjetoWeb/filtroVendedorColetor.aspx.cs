...
{
    public partial class filtroVendedorColetor : PaginaBase
    {
        #region [ PROPERTIES ]
        ...
        {
            string parametros = "rel=VENDEDORCOLETOR";
