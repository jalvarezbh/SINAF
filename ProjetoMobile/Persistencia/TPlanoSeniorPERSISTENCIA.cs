...
{
    public class TPlanoSeniorPERSISTENCIA
    {
        #region [ CONNECTION ]
        ...
        public TPlanoSeniorDOMINIO ConsultaCategoriaSuperior(int faixaPadaro, decimal valorPremioAPD)
        {
            try
            {
                StringBuilder queryTabelaPlanoSenior = new StringBuilder();
                StringBuilder queryTabelaPlanoSeniorMaior = new StringBuilder();
                StringBuilder queryTabelaPlanoSeniorMenor = new StringBuilder();

                queryTabelaPlanoSenior.Append(@" SELECT   IDPlanoSenior         ");
                queryTabelaPlanoSenior.Append(@"        , Codigo                ");
                queryTabelaPlanoSenior.Append(@"        , NomePlano             ");
                queryTabelaPlanoSenior.Append(@"        , CoberturaMorte        ");
                queryTabelaPlanoSenior.Append(@"        , Premio_61_65          ");
                queryTabelaPlanoSenior.Append(@"        , Premio_66_70          ");
                queryTabelaPlanoSenior.Append(@"        , Premio_71_75          ");
                queryTabelaPlanoSenior.Append(@"        , Premio_76_80          ");
                ...
                switch (faixaPadaro)
                {
                    case (int)FaixaEtaria.PREMIO_61_65:
                        queryTabelaPlanoSenior.Append(@"   , Premio_61_65 AS ValorPadrao  ");
                        queryTabelaPlanoSenior.Append(@"   FROM   TPlanoSenior            ");
                        queryTabelaPlanoSenior.Append(@"  WHERE   NomePlano = 'Superior'  ");
                        queryTabelaPlanoSeniorMenor.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMaior.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMenor.Append(@"        AND  Premio_61_65  <= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMenor.Append(@"   ORDER BY  Premio_61_65 DESC                      ");
                        queryTabelaPlanoSeniorMaior.Append(@"        AND  Premio_61_65  >= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMaior.Append(@"   ORDER BY  Premio_61_65                           ");
                        break;
                    case (int)FaixaEtaria.PREMIO_66_70:
                        queryTabelaPlanoSenior.Append(@"   , Premio_66_70 AS ValorPadrao  ");
                        queryTabelaPlanoSenior.Append(@"   FROM   TPlanoSenior            ");
                        queryTabelaPlanoSenior.Append(@"  WHERE   NomePlano = 'Superior'  ");
                        queryTabelaPlanoSeniorMenor.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMaior.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMenor.Append(@"        AND  Premio_66_70  <= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMenor.Append(@"   ORDER BY  Premio_66_70 DESC                      ");
                        queryTabelaPlanoSeniorMaior.Append(@"        AND  Premio_66_70  >= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMaior.Append(@"   ORDER BY  Premio_66_70                           ");
                        break;
                    case (int)FaixaEtaria.PREMIO_71_75:
                        queryTabelaPlanoSenior.Append(@"   , Premio_71_75 AS ValorPadrao  ");
                        queryTabelaPlanoSenior.Append(@"   FROM   TPlanoSenior            ");
                        queryTabelaPlanoSenior.Append(@"  WHERE   NomePlano = 'Superior'  ");
                        queryTabelaPlanoSeniorMenor.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMaior.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMenor.Append(@"        AND  Premio_71_75  <= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMenor.Append(@"   ORDER BY  Premio_71_75 DESC                      ");
                        queryTabelaPlanoSeniorMaior.Append(@"        AND  Premio_71_75  >= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMaior.Append(@"   ORDER BY  Premio_71_75                           ");
                        break;
                    case (int)FaixaEtaria.PREMIO_76_80:
                        queryTabelaPlanoSenior.Append(@"   , Premio_76_80 AS ValorPadrao  ");
                        queryTabelaPlanoSenior.Append(@"   FROM   TPlanoSenior            ");
                        queryTabelaPlanoSenior.Append(@"  WHERE   NomePlano = 'Superior'  ");
                        queryTabelaPlanoSeniorMenor.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMaior.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMenor.Append(@"        AND  Premio_76_80  <= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMenor.Append(@"   ORDER BY  Premio_76_80 DESC                      ");
                        queryTabelaPlanoSeniorMaior.Append(@"        AND  Premio_76_80  >= " + valorPremioAP + " ");
                        queryTabelaPlanoSeniorMaior.Append(@"   ORDER BY  Premio_76_80                           ");
                        break;                  
                    default:
                        queryTabelaPlanoSenior.Append(@"   , 0 AS ValorPadrao ");
                        queryTabelaPlanoSenior.Append(@"   FROM   TPlanoProtecao          ");
                        queryTabelaPlanoSenior.Append(@"  WHERE   NomePlano = 'Superior'  ");
                        queryTabelaPlanoSeniorMenor.Append(queryTabelaPlanoSenior.ToString());
                        queryTabelaPlanoSeniorMaior.Append(queryTabelaPlanoSenior.ToString());
                        break;
                ...
                using (SqlCeConnection conn = new SqlCeConnection(ConnectionString))
                {
                    ...
                    SqlCeCommand commandMenor = new SqlCeCommand(queryTabelaPlanoSeniorMenor.ToString(), conn);
                    ...
                    SqlCeCommand commandMaior = new SqlCeCommand(queryTabelaPlanoSeniorMaior.ToString(), conn);
                    ...
                    if ((dadosTableMenor.Rows.Count > 0) && (dadosTableMaior.Rows.Count > 0))
                    {
                        if (valorPremioAPD - Convert.ToDecimal(dadosTableMenor.Rows[0]["ValorPadrao"]) > Convert.ToDecimal(dadosTableMaior.Rows[0]["ValorPadrao"]) - valorPremioAPD)
                            return MontarDominioTPlanoSenior(dadosTableMaior.Rows[0]);
                        else
                            return MontarDominioTPlanoSenior(dadosTableMenor.Rows[0]);
                    }
                    else
                    {
                        ...
                        return new TPlanoSeniorDOMINIO();
                    }
                }
            }
            catch (Exception ex)
        ...
        #region [ MontarDominioTPlanoSenior ]

        public TPlanoSeniorDOMINIO MontarDominioTPlanoSenior(DataRow dadosDominio)
        {
            TPlanoSeniorDOMINIO dadosConsulta = new TPlanoSeniorDOMINIO();
            dadosConsulta.IDPlanoSenior = Convert.ToInt32(dadosDominio["IDPlanoSenior"]);
        ...
        #region [ MontarDominioTPlanoSeniorFuneral ]

        public TPlanoSeniorDOMINIO MontarDominioTPlanoSeniorFuneral(DataRow dadosDominio)
        {
            TPlanoSeniorDOMINIO dadosConsulta = new TPlanoSeniorDOMINIO();
            dadosConsulta.IDPlanoSeniorFuneral = Convert.ToInt32(dadosDominio["IDPlanoSeniorFuneral"]);
        ...
        public Dictionary<decimal, string> ListarTodosFuneralPrincipal(bool itemVazio, int idadeBase)
        {
            ...
            {
                StringBuilder queryTabelaPlanoSenior = new StringBuilder();
                queryTabelaPlanoSenior.Append(@" SELECT  DISTINCT CoberturaMorte ");
                queryTabelaPlanoSenior.Append(@"   FROM   TPlanoSenior           ");
                ...
                using (SqlCeConnection conn = new SqlCeConnection(ConnectionString))
                {
                    ...
                    SqlCeCommand command = new SqlCeCommand(queryTabelaPlanoSenior.ToString(), conn);
        ...
        public Dictionary<int, string> ListarTodosFuneralCategoria(bool itemVazio)
        {
            ...
            {
                StringBuilder queryTabelaPlanoSenior = new StringBuilder();
                queryTabelaPlanoSenior.Append(@"   SELECT  DISTINCT Codigo         ");
                queryTabelaPlanoSenior.Append(@"                  , NomePlano      ");
                queryTabelaPlanoSenior.Append(@"     FROM   TPlanoSenior           ");
                queryTabelaPlanoSenior.Append(@" ORDER BY   Codigo                 ");
        ...
        public TPlanoSeniorDOMINIO CalcularPremioFuneral(decimal valorPrincipalNovo, int valorCategoriaNovo, int idadeBase)
        {

            try
            {
                TPlanoSeniorDOMINIO planoFuneral = SelecionarPlanoSeniorFuneral(valorPrincipalNovo, valorCategoriaNovo);
        ...
        public decimal CalcularPremioAgregado(int grauParentesco, int idade, string valorCategoria)
        {
            ...
            try
            {
                TPlanoSeniorDOMINIO planoAgregado = new TPlanoSeniorDOMINIO();                              
        ...
        public TPlanoSeniorDOMINIO SelecionarPlanoSeniorFuneral(decimal coberturaMorte, int codigoPlano)
        {            
            StringBuilder queryTabelaPlanoSenior = new StringBuilder();
            ...
            queryTabelaPlanoSenior.Append(@"        , Premio_76_80          ");
            queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior            ");
            queryTabelaPlanoSenior.Append(@" WHERE  Codigo = " + codigoPlano + " ");
            queryTabelaPlanoSenior.Append(@"   AND  CoberturaMorte  = " + coberturaMorte.ToString().Replace(',', '.') + " ");
           
            TPlanoSeniorDOMINIO planoFuneral = new TPlanoSeniorDOMINIO();
            ...
            using (SqlCeConnection conn = new SqlCeConnection(ConnectionString))
            {
                ...
                if (dadosTable.Rows.Count > 0)
                    planoFuneral = MontarDominioTPlanoSenior(dadosTable.Rows[0]);
            }
        ...
        public TPlanoSeniorDOMINIO SelecionarPlanoPremioAgregado(string nomePlano, int codigoFaixa)
        {            
            StringBuilder queryTabelaPlanoSenior = new StringBuilder();

            queryTabelaPlanoSenior.Append(@" SELECT   IDPlanoSeniorFuneral   ");
            queryTabelaPlanoSenior.Append(@"        , Codigo                 ");
            queryTabelaPlanoSenior.Append(@"        , Categoria              ");
            queryTabelaPlanoSenior.Append(@"        , Ate_20                 ");
            queryTabelaPlanoSenior.Append(@"        , De_21_40               ");
            queryTabelaPlanoSenior.Append(@"        , De_41_50               ");
            queryTabelaPlanoSenior.Append(@"        , De_51_60               ");
            queryTabelaPlanoSenior.Append(@"        , De_61_65               ");
            queryTabelaPlanoSenior.Append(@"        , De_66_70               ");
            queryTabelaPlanoSenior.Append(@"        , De_71_75               ");
            queryTabelaPlanoSenior.Append(@"        , De_76_80               ");
            queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSeniorFuneral      ");
            queryTabelaPlanoSenior.Append(@" WHERE  Categoria = '" + nomePlano + "' ");
            queryTabelaPlanoSenior.Append(@"   AND  Codigo  = " + codigoFaixa + " ");
            ...
            using (SqlCeConnection conn = new SqlCeConnection(ConnectionString))
            {
                ...
                dadosTable.Load(dados);
                if (dadosTable.Rows.Count > 0)
                    planoAgregado = MontarDominioTPlanoSeniorFuneral(dadosTable.Rows[0]);
            }
        ...
        #region [ ConsultarPlanoSeniorFuneral ]

        public DataTable ConsultarPlanoSeniorFuneral(int faixaBase)
        {
            StringBuilder queryTabelaPlanoSenior = new StringBuilder();
            ...
            {
                case (int)FaixaEtaria.PREMIO_61_65:
                    queryTabelaPlanoSenior.Append(@"        , Premio_61_65  AS PremioValor ");
                    queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior                   ");
                    queryTabelaPlanoSenior.Append(@" WHERE  Premio_61_65 IS NOT NULL       ");
                    break;
                case (int)FaixaEtaria.PREMIO_66_70:
                    queryTabelaPlanoSenior.Append(@"        , Premio_66_70  AS PremioValor ");
                    queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior                   ");
                    queryTabelaPlanoSenior.Append(@" WHERE  Premio_66_70 IS NOT NULL       ");
                    break;
                case (int)FaixaEtaria.PREMIO_71_75:
                    queryTabelaPlanoSenior.Append(@"        , Premio_71_75  AS PremioValor ");
                    queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior                   ");
                    queryTabelaPlanoSenior.Append(@" WHERE  Premio_71_75 IS NOT NULL       ");
                    break;
                case (int)FaixaEtaria.PREMIO_76_80:
                    queryTabelaPlanoSenior.Append(@"        , Premio_76_80  AS PremioValor ");
                    queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior                   ");
                    queryTabelaPlanoSenior.Append(@" WHERE  Premio_76_80 IS NOT NULL       ");
                    break;
                default:
                    queryTabelaPlanoSenior.Append(@"  FROM  TPlanoSenior                   ");
                    break;
        ...
        #region [ ConsultarPlanoSeniorAgregado ]

        public DataTable ConsultarPlanoSeniorAgregado()
        {
            ...
            queryFaixa20_40.Append(@"  FROM  TPlanoSeniorFuneral      ");
            ...
            queryFaixa41_60.Append(@"  FROM  TPlanoSeniorFuneral      ");
            ...
            queryFaixa61_70.Append(@"  FROM  TPlanoSeniorFuneral      ");
            ...
            queryFaixa71_80.Append(@"  FROM  TPlanoSeniorFuneral      ");
